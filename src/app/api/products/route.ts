...
export async function GET(request: Request) {
  try {
    ...
    // Seed ONLY when the table is completely empty (first run on a fresh DB).
    // Do NOT reseed just because a category has zero items — that would
    // silently undo legitimate admin deletions.
